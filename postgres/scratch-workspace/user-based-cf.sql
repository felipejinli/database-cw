WITH      full_preview_audience AS (
          ...
          -- select * from broader_ratings where userid=53;
          -- ),
          --     ? i.e. similarity of users * preview user's rating of movieId=X
          ...
          SELECT    AVG(predicted_rating) AS "Predicted average broader audience rating",
                    STDDEV (predicted_rating)
